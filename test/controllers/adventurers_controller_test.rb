...
class AdventurersControllerTest < ActionController::TestCase
  ...
  test "should create adventurer" do
    assert_difference('Adventurer.count') do
      post :create, adventurer: { cha: @adventurer.cha, con: @adventurer.con, dex: @adventurer.dex, int: @adventurer.int, name: @adventurer.name, str: @adventurer.str, wis: @adventurer.wis }
    end
  ...
  test "should update adventurer" do
    patch :update, id: @adventurer, adventurer: { cha: @adventurer.cha, con: @adventurer.con, dex: @adventurer.dex, int: @adventurer.int, name: @adventurer.name, str: @adventurer.str, wis: @adventurer.wis }
    assert_redirected_to adventurer_path(assigns(:adventurer))
  end
